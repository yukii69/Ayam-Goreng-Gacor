                    ...
                    <div class="card-body">
                        ...
                        enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="judul_banner" class="form-control" id="text" value="{{ $banner->judul_banner }}">
                            </div>  
                            <div class="form-group">
                                <label for="deskripsi">Deskripsi</label>
                                <textarea type="text" name="deskripsi" class="form-control" >{{ $banner->deskripsi }}</textarea>
                            </div>  
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{ asset('uploads/banner/' . $banner->gambar_banner) }}" width="100">                                                                             
                            </div>                       
                        <div class="form-group">
